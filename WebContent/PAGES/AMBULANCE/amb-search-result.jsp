...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <a href="./PAGES/AMBULANCE/amb-search.jsp" class="btn btn-outline-success margin-left margin-right">BACK</a>
    </div>
  </div>
</nav>
	...
	<div class="">
		<div class="col-md-10 col-sm-4 col-xs-12">
			<form class="form-container">
				<div class="mb-3">
			    	<label for="exampleInputEmail1" class="form-label" style="font-size:20px; font-style:italic">LIST OF AMBULANCES</label>
			  	</div>
				<table class="table table-dark table-hover">
					<thead>
					  ...
					  <tbody>
					  <%
					  for(AmbulanceClass amb: ambulance)
					  {
					  %>
					    <tr>
					      <td><%=amb.getVlno() %></td>
