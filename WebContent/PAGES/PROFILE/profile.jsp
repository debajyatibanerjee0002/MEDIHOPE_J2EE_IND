	...
	<div class="">
		<div class="col-md-10 col-sm-4 col-xs-12">
			<form class="form-container" action="/MEDIHOPE/ProfileUpdateServlet" method="post">
			  ...
			  <div class="mb-3">
			    <label for="exampleInputPassword1" class="form-label">YOUR EMAIL ID</label>
			    <input type="email" class="form-control" id="exampleInputPassword1" value="${email}" name="email" readonly>
			  </div>
			  <div class="mb-3">
			...
			<%--   
			  <div class="mb-3">
			    ...
			    <input type="password" class="form-control" id="exampleInputPassword1" value="${pass}" name="password" >
			  </div>
			--%>
