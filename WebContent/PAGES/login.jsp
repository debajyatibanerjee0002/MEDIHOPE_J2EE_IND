...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <a href="./signup.jsp"><button type="button" class="btn btn-outline-success margin-left margin-right">SIGN UP</button></a>
    </div>
  </div>
</nav>
	...
	<div class="">
		<div class="col-md-10 col-sm-4 col-xs-12">
			<form class="form-container" action="/MEDIHOPE/LoginCheckServlet" method="post">
			  <div class="mb-3">
			  	<div id="emailHelp" class="form-text" style="color:red">${wrong}</div>
