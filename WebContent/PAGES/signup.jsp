		...
		<div class="col-md-10 col-sm-4 col-xs-12">
			<form class="form-container" autocomplete="off" action="/MEDIHOPE/SignupServlet" method="post">
			  ...
			  <div class="mb-3">
			    ...
			    <input type="text" class="form-control" id="exampleInputPassword1" name="name" placeholder="DEBAJYATI BANERJEE">
			  </div>
			  <div class="mb-3">
			    <label for="exampleInputPassword1" class="form-label" >New Password</label>
			    <input type="password" class="form-control" id="exampleInputPassword1" name="pass" placeholder="1234">
			  </div>
			  <div class="mb-3">
